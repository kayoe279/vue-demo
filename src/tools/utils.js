...
Utils.getfileUrlById = function (id) {
    // return (process.env.NODE_ENV !== 'production' ? config.devHttpUrl : config.buildHttpUrl) + '/kpapi/Upload/Download?Id=' + id;
...
// 生成随机字符串 - 默认32位
Utils.getRandomStr = function (num) {
    num = num || 32
    var str = ''
