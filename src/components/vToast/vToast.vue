 ...
 * @property {Boolean} showToast 是否显示toast
 * @property {String} title toast文字
 * @property {String} position toast位置 默认middle, 可选 top bottom (只在type为默认时生效)
 * @property {String} type 模式选择默认toast,可选 success成功 warning警告
 * @property {String} color 动画活动区域的颜色，只对 type = flower 模式有效（默认#c7c7c7）
 * @property {String Number} size 加载图标的大小，单位px
 * @property {String Number} duration toast显示时长 默认1500ms
 *
 */
export default {
  name: "vLoading",
